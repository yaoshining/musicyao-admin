...
(function( factory ) {
    if ( typeof define === 'function' && define.amd ) {
        define( ['angular','angular-animate'], factory );
    } else {
        factory(angular);
    }
})(function(angular){
    angular.module('ebp.toaster', ['ngAnimate'])
    ...
    .service('toaster', ['$rootScope', 'toasterConfig', function ($rootScope, toasterConfig) {
        this.pop = function (type, title, body, timeout, imageUrl, bodyOutputType, clickHandler,position) {
    ...
    .factory('toasterRegisterEvents', function() {
        ...
        return {
            ...
            refreshEvents: toasterFactory.refreshEvents
        }
    })
        ...
        function ($parse, $rootScope, $interval, $sce, toasterConfig, toaster, toasterRegisterEvents) {
            return {
                ...
                link: function (scope, elm, attrs) {
                    ...
                    attrs.$observe('light',function(val){
                        scope.light = val;
                    });
                    scope.config = {
                    ...
                    toasterRegisterEvents.refreshEvents();
                ...
                '<div  id="toast-container" ng-class="[config.position, config.animation]">' +
                    '<div ng-repeat="toaster in toasters" class="toast {{light==\'true\'?\'toast-light\':\'\'}}" ng-class="[toaster.type,toaster.position]" ng-click="click(toaster)" ng-mouseover="stopTimer(toaster)"  ng-mouseout="restartTimer(toaster)">' +
                        '<button class="toast-close-button" ng-show="config.closeButton" ng-click="click(toaster, true)"></button>' +
                        '<img ng-src="{{toaster.imageUrl}}" class="toast-image" ng-if="toaster.imageUrl">'+
                        '<div class="toast-item" ng-class="{\'toast-with-image\': toaster.imageUrl,\'toast-without-image\': !toaster.imageUrl}">' +
