/**
 * Created by 世宁 on 2015/3/11 0011.
 */
(function( factory ) {
    if ( typeof define === 'function' && define.amd ) {
        define( [ window,'angular'], factory );
    } else {
    ...
    function BreadcrumbDirective($interpolate, $breadcrumb, $rootScope) {
        var $$templates = {
            ...
            '<i class="home-icon fa fa-home" ng-if="$first"></i>' +
            '<a ng-switch-when="false" href="{{step.ncyBreadcrumbLink}}">{{step.ncyBreadcrumbLabel}}</a> ' +
            '<span ng-switch-when="true">{{step.ncyBreadcrumbLabel}}</span>' +
            '</li>' +
            '</ol>'
    ...
    angular.module('ebp.breadcrumb', ['ui.router.state'])
        .provider('$breadcrumb', $Breadcrumb)
        .directive('ebpBreadcrumb', BreadcrumbDirective)
        .directive('ebpBreadcrumbLast', BreadcrumbLastDirective);
}));
